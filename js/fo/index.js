new window.Vue({
  ...
  components: {
    ...
    'home-page': window.httpVueLoader('https://rnetwork.imfast.io/' + data.cloudDirectory + '/components/HomePage.vue'),
    'home-page-india': window.httpVueLoader('https://rnetwork.imfast.io/' + data.cloudDirectory + '/components/HomePageIndia.vue'),
