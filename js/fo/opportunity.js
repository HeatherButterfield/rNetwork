new window.Vue({
  ...
  components: {
    ...
    'opportunity-page': window.httpVueLoader('https://rnetwork.imfast.io/' + data.cloudDirectory + '/components/OpportunityPage.vue'),
    'opportunity-page-india': window.httpVueLoader('https://rnetwork.imfast.io/' + data.cloudDirectory + '/components/OpportunityPageIndia.vue'),
