new window.Vue({
  ...
  components: {
    ...
    'policies-page': window.httpVueLoader('https://rnetwork.imfast.io/' + data.cloudDirectory + '/components/PoliciesPage.vue'),
    'policies-page-india': window.httpVueLoader('https://rnetwork.imfast.io/' + data.cloudDirectory + '/components/PoliciesPageIndia.vue'),
