new window.Vue({
  ...
  components: {
    ...
    'onboarding-page': window.httpVueLoader('https://rnetwork.imfast.io/' + data.cloudDirectory + '/components/OnboardingPage.vue'),
    'onboarding-page-india': window.httpVueLoader('https://rnetwork.imfast.io/' + data.cloudDirectory + '/components/OnboardingPageIndia.vue'),
