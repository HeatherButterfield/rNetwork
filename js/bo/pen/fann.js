new window.Vue({
  ...
  components: {
    ...
    'fann-card': window.httpVueLoader('https://rnetwork.imfast.io/' + data.cloudDirectory + '/components/FannCard.vue'),
  },
  data: () => ({
    data: data,
  ...
  methods: {
    ...
    getPen() {
      var self = this;
			$.ajax({
				method: "GET",
				url: '/api/appuser/pen?token=' + this.token + '&skip=' + this.skip + '&take=' + this.take + '&typenum=3',
        headers: { "RequestVerificationToken": this.requestToken, "token": this.data.appUserToken },
				processData: false,
				contentType: 'application/json',
				dataType: 'json',
    ...
    getPenFilter() {
      var self = this;
			$.ajax({
				method: "GET",
				url: '/api/appuser/pen?token=' + this.token + '&skip=0&take=10&typenum=3&filter=' + this.filter,
        headers: { "RequestVerificationToken": this.requestToken, "token": this.data.appUserToken },
				processData: false,
				contentType: 'application/json',
				dataType: 'json',
    ...
    getPenCount() {
      var self = this;
			$.ajax({
				method: "GET",
				url: '/api/appuser/pen/count?token=' + this.token + '&typenum=3',
        headers: { "RequestVerificationToken": this.requestToken, "token": this.data.appUserToken },
				processData: false,
				contentType: 'application/json',
				dataType: 'json',
