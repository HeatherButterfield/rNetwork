  ...
  methods: {
      ...
      console.log(this.data.appUserToken);
        ...
        headers: { "RequestVerificationToken": this.token, "token": this.data.appUserToken },
				...
				dataType: 'json',
        data: JSON.stringify({Password: this.password, ConfirmPassword: this.passwordConfirm, Email: this.data.appUser.email}),
          ...
          window.location.replace('/r/bo/account/password/success');
				}
			});
		}
  },
