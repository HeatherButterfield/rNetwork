new window.Vue({
  ...
  data: () => ({
    data: data,
    phoneCountryCode: data.appUser.phoneCountryCode,
    phoneNumber: data.appUser.phoneNumber.replace(/\D/g,''),
